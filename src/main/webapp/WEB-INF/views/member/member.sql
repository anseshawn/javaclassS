...
/* 날짜 형식 비교 */
/* (옵션, 날짜, 날짜) 뒤에서 앞을 뺀 값 */
select lastDate, timestampdiff(day, lastDate, now()) as deleteDiff from member2;

select count(*) from member2 where level=1 and timestampdiff(day,startDate,now()) <= 7;
...
insert into member2Chat values (default, 'admin', '안녕');
insert into member2Chat values (default, 'admin', '반갑습니다');
insert into member2Chat values (default, 'admin', 'o.0');
insert into member2Chat values (default, 'admin', '0.o');
insert into member2Chat values (default, 'hkd1234', '안녕하세요');
insert into member2Chat values (default, 'hkd1234', '오랜만입니다');
insert into member2Chat values (default, 'atom1234', '잘오셨습니다');
insert into member2Chat values (default, 'kms1234', '안녕아녕');
insert into member2Chat values (default, 'admin', '안녕');
insert into member2Chat values (default, 'admin', '안녕10');
insert into member2Chat values (default, 'admin', '안녕11');
insert into member2Chat values (default, 'admin', '안녕12');
insert into member2Chat values (default, 'admin', '안녕13');
insert into member2Chat values (default, 'admin', '안녕14');
insert into member2Chat values (default, 'admin', '안녕15');
insert into member2Chat values (default, 'admin', '안녕16');
insert into member2Chat values (default, 'admin', '안녕17');
insert into member2Chat values (default, 'admin', '안녕18');
insert into member2Chat values (default, 'admin', '안녕19');
insert into member2Chat values (default, 'admin', '안녕20');
insert into member2Chat values (default, 'admin', '안녕21');
