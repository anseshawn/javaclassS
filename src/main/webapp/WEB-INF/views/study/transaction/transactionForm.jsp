...
<head>
  ...
  <script>
    ...
    function userDelete(idx) {
    	...
    	if(!ans) return false;
    	else location.href="${ctp}/dbtest/dbtestDelete?tempFlag=transaction&idx="+idx;
    }
...
<p><br/></p>
<div class="container">
	<pre>트랜잭션: 컨트롤러 혹은 서비스에서 사용(인터페이스에선 사용불가하다)
		전체에 줘야 하면 컨트롤러에서 사용, 아니라면 DB에 가까운곳(서비스객체)에서 사용하는 것이 좋다</pre>
  <h2>회 원 리 스 트2</h2>
  <br/>
  <div class="row">
    <div class="col-7">
