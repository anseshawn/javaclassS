		...
		function qrCodeCheck() {
			...
			$.ajax({
				...
				success: function(vo){
					...
					str += '구매자 이름 : '+vo.name+'<br/>';
					str += '구매자 이메일 : '+vo.email+'<br/>';
					str += '영화 제목 : '+vo.movieName+'<br/>';
					str += '상영일자 : '+vo.movieDate+'<br/>';
					str += '상영시간 : '+vo.movieTime+'<br/>';
					str += '관람인원(성인) : '+vo.movieAdult+'<br/>';
					str += '관람인원(소인) : '+vo.movieChild+'<br/>';
					str += '';
...
<div class="container">
    ...
    <table class="table table-bordered text-center">
      ...
      <tr>
        <th>이메일</th>
        <td><input type="text" name="email" id="email" value="pr0911237@gmail.com" required class="form-control"/></td>
      </tr>
      <tr>
        <th>영화명 선택</th>
        <td>
