...
<div class="container">
	...
	<script>
	    ...
	    mapOption = { 
	        center: new kakao.maps.LatLng(36.63517831706157, 127.459535598743), // 지도의 중심좌표
	        level: 3 // 지도의 확대 레벨
	    };
	    ...
	    message += '<input type="button" value="장소저장" onclick="addressSave('+latlng.getLat()+','+latlng.getLng()+')" class="btn btn-sm btn-primary"/></p>';
	    message += '';
