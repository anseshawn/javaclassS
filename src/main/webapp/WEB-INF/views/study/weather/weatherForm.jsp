...
<head>
  ...
  <script>
    ...
    $.getJSON('https://api.openweathermap.org/data/2.5/weather?q=Seoul,kr&appid=237a07d045793d996f10943b24e831a2&units=metric',
    ...
    function weatherCheck2() {
	    ...
	    $.getJSON('https://api.openweathermap.org/data/2.5/weather?lat='+position.coords.latitude+'&lon='+position.coords.longitude+'&appid=237a07d045793d996f10943b24e831a2&units=metric',
  	    function (WeatherResult) {
	    	  $(".dispForm2").show();
    ...
    function weatherCheck3() {
	    ...
	    $.getJSON('https://api.openweathermap.org/data/2.5/weather?lat='+positionObj.latitude+'&lon='+positionObj.longitude+'&appid=237a07d045793d996f10943b24e831a2&units=metric',
  	    function (WeatherResult) {
	    	  $(".dispForm3").show();
