...
<div class="container">
	...
	<div>
		사용 단어의 빈도수 구하기 :
		<textarea rows="5" name="content" id="content" class="form-control" placeholder="문장을 입력하세요."></textarea>
		<div class="row mt-2">
			<div class="col">
				<input type="button" value="TextArea내용 분석" onclick="wordCheck1()" class="btn btn-success" />
				<input type="button" value="Sample.txt내용 분석" onclick="wordCheck2()" class="btn btn-success" />
				<input type="button" value="뉴스 크롤링 분석" onclick="wordCheck3()" class="btn btn-success" />
			</div>
		...
		<div class="input-group">
			<div class="input-group-text">제외할 문자열('/'로 구분해서 입력하세요)</div>
				<input type="text" name="excludeWord" id="excludeWord" value="[속보]/[단독]" class="form-control"/>
